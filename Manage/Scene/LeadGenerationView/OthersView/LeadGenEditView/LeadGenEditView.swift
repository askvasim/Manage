...
struct LeadGenEditView<VM: LeadGenEditViewModel>: View {
    @StateObject var viewModel: VM
    @InjectedObject private var navigator: DefaultLeadGenEditNavigator
...
#Preview {
    LeadGenEditView(viewModel: DefaultLeadGenEditViewModel(), leadData: LeadList(firstName: "", middleName: "", lastName: "", contactNumber: "", specialty: "", hospitalName: "", hospitalContactNumber: "", addressLine1: "", addressLine2: "", landmark: "", state: "", city: "", pin: "", purpose: "", note: "", status: ""))
}
